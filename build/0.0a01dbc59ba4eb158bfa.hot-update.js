...
/***/ function(module, exports, __webpack_require__) {
	...
	var Toma = _react2.default.createClass({
				...
				shouldComponentUpdate: function shouldComponentUpdate(pprops, pstate) {
							if (pprops.w !== this.props.w || pprops.h !== this.props.h || pprops.rule !== this.props.rule || pprops.y !== this.props.y || pprops.scale !== this.props.scale) return true;
				},
	...
	var App = _react2.default.createClass({
				...
				setRule: function setRule(e) {
							this.history.pushState(null, '/', { rule: parseInt(this.state.ruleText) });
				},
