...
/***/ function(module, exports, __webpack_require__) {
	...
	var Toma = _react2.default.createClass({
				...
				calcnext: function calcnext(row, times) {
							var next = [];
							times = times || 1;
				...
				paint: function paint(context) {
							console.log('painting', this.state.y, this.state.firstrow.join());
							var row = this.state.firstrow;
							this.context.save();
							for (var y = -10 + this.state.y; y < this.state.y + this.props.h + 10; y++) {
										this.drawrow(row, y);
				...
				goup: function goup() {
							...
							this.setState({ firstrow: next10, y: this.state.y - 10 });
				},
