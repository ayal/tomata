...
/***/ function(module, exports, __webpack_require__) {
	...
	var Toma = _react2.default.createClass({
				...
				getInitialState: function getInitialState() {
							return { ruleText: '' + this.props.rule, firstrow: this.props.rrow(), scale: this.props.scale };
				},
				...
				render: function render() {
							...
							return _react2.default.createElement(
										...
										_react2.default.createElement(
													'div',
													null,
													_react2.default.createElement('canvas', { ref: 'canvas', width: this.props.w * this.state.scale, height: this.state.h * this.state.scale })
										)
							);
				}
	});
