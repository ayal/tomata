...
/***/ function(module, exports, __webpack_require__) {
	...
	var Toma = _react2.default.createClass({
				...
				componentWillUpdate: function componentWillUpdate(nprops, nstate) {
							this.context = this.refs.canvas.getContext('2d');
							this.context.clearRect(0, 0, nprops.w * nstate.scale, nprops.h * nstate.scale);
							this.paint();
				},
				...
				paint: function paint(context) {
							...
							this.context.save();
							for (var y = this.state.y; y < this.state.y + this.props.h; y++) {
										this.drawrow(row, y);
	...
	var App = _react2.default.createClass({
				...
				render: function render() {
							...
							return _react2.default.createElement(Toma, { w: w, scale: scale, rule: rule, rrow: this.rrow, setRule: this.setRule, h: 200, y: 0 });
				}
	});
